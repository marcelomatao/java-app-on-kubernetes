...
public class CustomerController {
	...
	public ResponseEntity<Resource<Customer>> create(@RequestBody Customer newCustomer) {
		Customer created = this.repository.save(newCustomer);
		Resource<Customer> resource = new Resource<>(created);
		resource.add(this.entityLinks.linkToSingleResource(Customer.class, created.getId()));
	...
	HttpEntity<Resource<Customer>> showCustomer(@PathVariable Long id) {
		...
		Resource<Customer> resource = new Resource<>(found.get());
